...
//                break;
    ...
    public static MemberResponseDTO.MyMissionPreViewListDTO mymissionPreViewListDTO(Page<Mission> mymissionList){

        List<MemberResponseDTO.MyMissionPreViewDTO> mymissionPreViewDTOList = mymissionList.stream()
